...
- **[to-spec](./skills/engineering/to-spec/SKILL.md)** — Convert loose thoughts into a strict-Gherkin-in-markdown spec under `docs/specs/`. Batches clarifying questions for actor, motivation, preconditions, observable outcomes, unhappy path, and edge cases until the spec is unambiguous, then writes it.
